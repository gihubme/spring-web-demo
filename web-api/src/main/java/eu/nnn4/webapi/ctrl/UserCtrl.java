...
public class UserCtrl {
    ...
    @PostMapping(value = "/shippingAddress/", produces = { "application/json" }, consumes = { MediaType.APPLICATION_JSON_VALUE, MediaType.TEXT_PLAIN_VALUE })
    ...
    @ResponseStatus(HttpStatus.OK)
    @GetMapping(value = "/hippingAddress/all/", produces = { "application/json" })
